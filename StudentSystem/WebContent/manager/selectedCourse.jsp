...
<br><br>
	<form action="StudentCourseTableServlet?type=managerselectgrade" method="post" onsubmit="return validate();">
<table border="1">
<tr  height="30" >
...
<% StudentCourseTableDAO dao=new StudentCourseTableDAO();
          ...
          List<StudentCourseTable> list=dao.selectedCourse(); 
        	...
        	%>
        	   <tr>
                ...
                <td>
					 ...
					 <button class="btn1"name="courseId" type="submit" value=<%=tl.getCourseId() %>>查看成绩</button>
