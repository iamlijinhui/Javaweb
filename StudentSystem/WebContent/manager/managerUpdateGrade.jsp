		...
		<div class="resume_main">
			...
			<div class="resume_left">
				...
				<div class="all_resume" style="text-align: center;" align="center">
					<!--------------------- 简历基本信息添加 ------------------------->
					<form action="StudentCourseTableServlet?type=managerupdategrade_submit" method="post" onsubmit="return validate();">
						<div class="table_style" style="margin-left:150px;">
						<table width="350" border="0" cellpadding="3" cellspacing="1"
								bgcolor="#EEEEEE">
								<tr>
									<td width="110" align="right" bgcolor="#F8F8F8">成绩：</td>
									<td bgcolor="#F8F8F8" align="left"><input type="text" id="grade"
										name="grade"> <font style="color: red">*</font></td>
								</tr>
							</table>
							...
							<table width="350" border="0" cellpadding="3" cellspacing="1"
								bgcolor="#EEEEEE">
								<tr>
									<td width="110" align="right" bgcolor="#F8F8F8">确认成绩：</td>
									<td bgcolor="#F8F8F8" align="left"><input type="text" id="grade2"
										name="grade2"> <font style="color: red">*</font></td>
								</tr>
							</table>
