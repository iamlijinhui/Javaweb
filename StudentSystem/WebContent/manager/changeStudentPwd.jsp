		...
		<div class="resume_main">
			...
			<div class="resume_left">
				...
				<div class="all_resume" style="text-align: center;" align="center">
					<!--------------------- 简历基本信息添加 ------------------------->
					<form action="StudentBasicinfoServlet?type=changeStudentPwd" method="post" onsubmit="return validate();">
						...
						<table width="350" border="0" cellpadding="3" cellspacing="1"
							...
							<table width="350" border="0" cellpadding="3" cellspacing="1"
								...
								<tr>
									...
									<td bgcolor="#F8F8F8" align="left"><input type="text" id="passwd"
										name="passwd" value="000000"> <font style="color: red">*</font></td>
								</tr>
							</table>
