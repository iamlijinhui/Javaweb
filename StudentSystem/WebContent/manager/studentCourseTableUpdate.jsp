...
<%@ page
	import="com.stu_info_manage.dao.StudentCourseTableDAO,com.stu_info_manage.bean.StudentCourseTable,com.stu_info_manage.bean.Student"%>
<%
...
left:250px;
top:0px;
width:800px ;line-height:300%; background-color:#ffffff ">
<br><br>
	<form action="StudentCourseTableServlet?type=deleteCourse" method="post" onsubmit="return validate();">
<table border="1">
<tr  height="30" >
 <td width="100">课程ID</td>  <td width="150">课程名</td><td width="100">授课教室</td><td width="200">授课教师</td><td align="center" width="100">授课时间</td><td style=" background-color:green;"> <a class="one" href="manager/addCourse.jsp" >添加课程</a></td></tr>

<% StudentCourseTableDAO dao=new StudentCourseTableDAO();
        
          List<StudentCourseTable> list=dao.ManagerSelectCourse(); 
        	...
        	%>
        	   <tr>
                ...
                <td>
					 ...
					 <button class="btn1"name="courseId" type="submit" value=<%=tl.getCourseId() %>>删除课程</button>
