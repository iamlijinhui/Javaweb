...
<br><br>
	<form action="StudentCourseTableServlet?type=selectCourse" method="post" onsubmit="return validate();">
<table border="1">
<tr  height="30" >
 <td width="100">课程ID</td>  <td width="150">课程名</td><td width="100">授课教室</td><td width="200">授课教师</td><td align="center" width="100">授课时间</td></tr>
...
<% StudentCourseTableDAO dao=new StudentCourseTableDAO();
         Student student = (Student)request.getSession().getAttribute("SESSION_STUDENT");
          List<StudentCourseTable> list=dao.selectCT(student.getStudentId()); 
        	...
        	%>
        	   <tr>
                ...
                <td>
					 ...
					 <button class="btn1"name="select" type="submit" value=<%=tl.getCourseId() %>>选课</button>
